...
class NutriSettings extends StatefulWidget {
  const NutriSettings({super.key});

  @override
  State<NutriSettings> createState() => _NutriSettingsState();
}
...
class _NutriSettingsState extends State<NutriSettings> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: const NutriBottomNavigator("Settings"),
      body: Container(
